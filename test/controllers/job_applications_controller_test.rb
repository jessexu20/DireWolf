...
class JobApplicationsControllerTest < ActionController::TestCase
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post :create, job_application: { coverletter: @job_application.coverletter, email: @job_application.email, name: @job_application.name }
    end
  ...
  test "should update job_application" do
    patch :update, id: @job_application, job_application: { coverletter: @job_application.coverletter, email: @job_application.email, name: @job_application.name }
    assert_redirected_to job_application_path(assigns(:job_application))
  end
