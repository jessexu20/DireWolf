...
1. Search function can be performed without logging in, based on the title, description, field,  Employer, and by Tags
...
Cucumber testing
=======
2. A super admin: admin@admin.com cannot be modified
...
3. Jobs and Applications will be deleted upon delete of the Employer (say, disappear)
...
4. A JobSeeker can view related Jobs/Recommendations based on what Jobs they have applied to in the past
...
5. Each controller and model have at least one test covering it
...
2. Emails would be sent to the job seeker after submitting applications or status changing
...
admin@admin.com PW:12345678

adm1ncsu@hotmail.com PW:project1

Employer:

abc@yahoo.com PW:12345678

emp1ncsu@gmail.com PW:project1

emp2ncsu@hotmail.com PW:project1

Job Seeker:

std1ncsu@hotmail.com PW:project1
